class Target
  attr_gtk
  COLORS = %i[blue green indigo orange red violet yellow]

  attr_accessor :args, :color, :sprite
  attr_reader :line
  ...
  def reached_home?
    args.geometry.intersect_rect?(sprite, args.state.background.player_home)
  end
  ...
  def update_color(color)
    @color = color
    sprite.path = "sprites/square/#{color}.png"
  end
