...
def initialize_lines(args)
  @lines = args.state.lines = [
    ...
    Line.new(args: args, x: 500, y: 300, cells: 5, direction: :up),
    Line.new(args: args, x: 550, y: 300, cells: 5, direction: :up),
    Line.new(args: args, x: 600, y: 300, cells: 5, direction: :up),
    Line.new(args: args, x: 650, y: 300, cells: 5, direction: :up)
  ]
end
